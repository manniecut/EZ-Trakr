...
function generateItemElement(item) {              //formats the STORED items for use in the list
    ...
    <li data-item-id="${item.trackingNum}">
      <span class="package-item js-package-item tracking-title">${item.carrier.toUpperCase()} <img class="title-icon" src="images/EZ-Trakr-icon2.png"> ${item.trackingNum}</span>
